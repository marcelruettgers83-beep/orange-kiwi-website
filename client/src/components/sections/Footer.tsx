    ...
    <footer className="py-12 bg-white border-t border-border">
      <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="text-sm text-muted-foreground order-2 md:order-1">
          © {new Date().getFullYear()} Orange Kiwi – All rights reserved.
        </div>
        ...
        <div className="flex items-center gap-8 order-1 md:order-2">
          ...
          <a href="https://www.linkedin.com/in/blair-bailey-acma-21437b4/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center rounded-full bg-secondary hover:bg-primary hover:text-white transition-all text-muted-foreground">
